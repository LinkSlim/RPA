...
(:goal (and
   ...
   (communicated_soil_data waypoint4) ; Queremos que se hayan comunicado datos de suelo de waypoint4
   (communicated_rock_data waypoint4) ; Queremos que se hayan comunicado datos de roca de waypoint4
   (communicated_image_data objective1 high_res)
   (at rover0 waypoint1) ; Queremos que el rover termine en waypoint1
   )
)
)
