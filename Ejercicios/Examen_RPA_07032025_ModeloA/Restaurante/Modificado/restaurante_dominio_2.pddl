(define (domain restaurante-dom)
  ...
  (:types persona porcion-pan porcion-relleno bocadillo bandeja - ubicable
          cocina mesa - lugar
          bocadillo - nombre-comida
          cocinero comensal - persona
  )
  ...
  (:action hacer_bocadillo
    :parameters (?nb - bocadillo ?b - porcion-pan
                 ?r - porcion-relleno ?k - cocina
                 ?c - cocinero
    )
    :precondition (and
                      (en ?b ?k)
  ...
  (:action mover_bandeja
    ...
    :parameters (?c - cocinero ?l1 ?l2 - lugar)
    :precondition (and
                     (en ?c ?l1)
                     (or (adyacente ?l1 ?l2)
                         (adyacente ?l2 ?l1))
